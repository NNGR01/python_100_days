##Import the objects, art and random
import random
...
def account(a):
#""Funcion que toma un elemento y devuelve un string con los datos""
  a_name = a['name']
...
#"""Funcion que compara los followres de objetos"""  
...
while end_game:
  ...
  # Generate a random item of diccionary
  person_a = person_b
  person_b = random.choice(data)
  ...
  if is_correct:
    count += 1
    print(f'You`re rigth! Current score : {count}')
  else:
    end_game = False
